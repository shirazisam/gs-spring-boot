...
`src/main/java/rest/HelloController.java`
[source,java]
----
include::initial/src/main/java/rest/HelloController.java[]
----
...
[source,java]
----
include::complete/src/main/java/rest/Application.java[]
----
...
`src/test/java/rest/HelloControllerTest.java`
[source,java]
----
include::complete/src/test/java/rest/HelloControllerTest.java[]
----
...
`src/test/java/rest/HelloControllerIT.java`
[source,java]
----
include::complete/src/test/java/rest/HelloControllerIT.java[]
----
